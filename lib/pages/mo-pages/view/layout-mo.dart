...
class LayoutMO extends StatefulWidget {
  const LayoutMO({super.key});

  @override
  State<LayoutMO> createState() => _LayoutMOState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: MotionTabBar(
        ...
        labels: const ["Home", "Karyawan", "Laporan"],
        icons: const [Icons.home, Icons.person, Icons.note],
